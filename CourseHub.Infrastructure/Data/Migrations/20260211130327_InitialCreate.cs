        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EndDateUtc = table.Column<DateOnly>(type: "date", nullable: false),
                    Location = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Capacity = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseInstances_Id", x => x.Id);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_CourseInstances_Teachers_TeacherId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseInstances_TeacherId",
                table: "CourseInstances",
                column: "TeacherId");
            ...
            migrationBuilder.CreateIndex(
                name: "UQ_Enrollments_Student_CourseInsance",
                table: "Enrollments",
